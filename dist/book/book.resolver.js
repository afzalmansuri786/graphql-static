...
__decorate([
    (0, graphql_1.Mutation)(returns => String, { name: 'deletBook' }),
    __param(0, (0, graphql_1.Args)({ name: 'bookId', type: () => graphql_1.Int })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
...
__decorate([
    ...
    __param(0, (0, graphql_1.Args)({ name: 'bookId', type: () => graphql_1.Int })),
    __param(1, (0, graphql_1.Args)('updaBookArgs')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, add_books_args_1.AddBookArgs]),
    __metadata("design:returntype", String)
